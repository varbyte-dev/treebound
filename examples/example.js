...
// ============================================
let UserCard = class UserCard extends TreeBoundElement {
    render() {
...
// ============================================
let TodoList = class TodoList extends TreeBoundElement {
    render() {
        this.templateRoot.innerHTML = `
      <div>
        <h3>{{ title }}</h3>
...
// ============================================
let UserForm = class UserForm extends TreeBoundElement {
    render() {
        this.templateRoot.innerHTML = `
...
// ============================================
let ConditionalRender = class ConditionalRender extends TreeBoundElement {
    render() {
        this.templateRoot.innerHTML = `
      <div>
